...
export async function getNotificationCount() {
  const response = await axiosInstance.get("/users/notification-count");
  return response.data;
}
...
export async function getMissedCallCount() {
  const response = await axiosInstance.get("/chat/calls/missed-count");
  return response.data;
}

export async function markCallsSeen() {
  const response = await axiosInstance.put("/chat/calls/seen");
  return response.data;
}
