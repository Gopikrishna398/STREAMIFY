  ...
  return (
    <div className="min-h-screen" data-theme={theme}>
        <Routes>
            ...
            <Route path="/sigin" element={<Navigate to="/signin" replace />} />
            <Route path="/signin" element={!authUser ? <SignInPage/> : <Navigate to={isOnboarded ? "/" : "/onboarding"} replace />} />
            <Route path="/signup" element={!authUser ? <SignInPage/> : <Navigate to={isOnboarded ? "/" : "/onboarding"} replace />} />
